...
export const metadata: Metadata = {
  title: "Layanan Kami",
  description:
    "Jasa pindahan profesional untuk rumah, kantor, apartemen, dan gudang. Layanan packing, bongkar pasang furniture, dan handling barang berat.",
};
      ...
      <div className="container mx-auto px-margin-desktop">
        <div className="text-center mb-12">
          <h1 className="font-headline-lg text-headline-lg mb-4">
            Layanan Pindahan Kami
          </h1>

          <div className="w-20 h-1 bg-secondary mx-auto" />

          <p className="text-on-surface-variant font-body-md max-w-2xl mx-auto mt-4">
            Kami menyediakan berbagai layanan pindahan profesional untuk
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
          {services.map((service) => (
            <Card
              key={service.id}
              className="group hover:shadow-lg transition-all overflow-hidden flex flex-col"
            >
