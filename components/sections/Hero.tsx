    ...
    >
      ...
      <div className="absolute inset-0 z-0 flex">
        ...
        <div className="w-full md:absolute md:right-0 md:top-0 md:bottom-0 md:w-[50%]">
          <div className="absolute inset-0">
            <Image
              src="/hero-office.jpg"
              alt="Tim PindahanRumah melakukan relokasi kantor profesional di Jakarta"
              fill
              priority
              quality={90}
          ...
          <div
            className="absolute inset-0 bg-gradient-to-r from-black/60 via-black/70 to-black/85"
            aria-hidden="true"
          />
        </div>
      </div>
      ...
      <div className="container-main relative z-20 w-full">
        <div className="max-w-xl text-white py-20 md:py-0">
          ...
          >
            Solusi pindahan terlengkap untuk Kantor, Rumah, Apartemen, hingga
            Gudang dengan jaminan keamanan 100%.
          </motion.p>
