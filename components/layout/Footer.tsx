...
const additionalServices = (services as Service[]).filter(
...
export default function Footer() {
  ...
  return (
    <footer aria-label="Footer" className="bg-primary text-white">
      {/* CTA Banner */}
      <section
        className="bg-deep-onyx py-16 md:py-20"
      ...
      <div className="max-w-container-max mx-auto px-4 md:px-margin-desktop py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        {/* Layanan - dibagi dua sub-kategori */}
        <div>
          ...
          <div className="mb-6">
            <p className="font-montserrat font-bold text-xs tracking-widest uppercase text-secondary/80 mb-3">
              Layanan Pindahan
            </p>
        ...
        <div>
          ...
          <address className="space-y-4 not-italic">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-montserrat font-bold text-xs text-white/50 uppercase tracking-wider mb-1">
                  Hotline 24/7
                </p>
                <a
                  href={`tel:${company.phone}`}
                  className="text-white/80 font-franklin text-sm hover:text-secondary transition-colors"
                >
                  {company.phone}
                </a>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 font-franklin text-sm">
                  {company.address}
                </p>
              </div>
            </div>
      ...
      <div className="border-t border-white/10 max-w-container-max mx-auto px-4 md:px-margin-desktop py-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-white/50 font-franklin text-xs">
        <p>
          © {currentYear} {company.name}. Professional Relocation Services. All
          Rights Reserved.
        </p>
